...
tput cup 6 30
echo -e "\x1b[42m TRIPLE RRR OFFICIAL YouTube Channel \x1b[m"
tput cup 9 0
echo -en "\e[93m Boss What Is Your Name : \e[m"
read answer
tput cup 12 22
echo -e "\e[104m Hello! Open A New Session!! $answer! \e[m"
tput cup 15 0
echo -en "\e[93m Have You Subscribe My Channel for TRIPLE RRR OFFICIAL (y/n)? \e[m "
read answer
...
tput cup 17 23
    echo -e "\x1b[41m Please Subsrcibe My Channel For TRIPLE RRR OFFICIAL \x1b[m"
fi
tput cup 20 0
figlet -f slant "RRR From TRIPLE RRR OFFICIAL" |lolcat
echo " "
echo " "
#done setting up
